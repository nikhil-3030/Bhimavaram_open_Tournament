    ...
    <section>
        ...
        <div class='tournament'>
            ...
            <ul class='round round-2'>
                ...
                <li class='game-left game-bottom'>Sahul</li>
                <li class='spacer'>&nbsp;</li>
                <li class='game-left game-top'>Anu</li>
                <li class='game-left spacer'>&nbsp;</li>
                <li class='game-left game-bottom'>Chandu</li>
                <li class='spacer'>&nbsp;</li>
                <li class='game-left game-top'>Shanu</li>
            ...
            <ul class='round round-3'>
                ...
                <li class='game-left game-bottom'>Q2</li>
                <li class='spacer'>&nbsp;</li>
            ...
            <ul class='round round-2'>
                ...
                <li class='game-right spacer'>&nbsp;</li>
                <li class='game-right game-bottom'>R 10</li>
                <li class='spacer'>&nbsp;</li>
                <li class='game-right game-top'>KSN</li>
                <li class='game-right spacer'>&nbsp;</li>
                <li class='game-right game-bottom'>Ramesh</li>
                <li class='spacer'>&nbsp;</li>
                <li class='game-right game-top'>R13</li>
                <li class='game-right spacer'>&nbsp;</li>
                <li class='game-right game-bottom'>Vamsi</li>
                <li class='spacer'>&nbsp;</li>
                <li class='game-right game-top'>Ramikrishna Jr</li>
                <li class='game-right spacer'>&nbsp;</li>
                <li class='game-right game-bottom'>Ramikrishna</li>
                <li class='spacer'>&nbsp;</li>
            </ul>
            <ul class='round round-1'>
                <li class='spacer'>&nbsp;</li>
