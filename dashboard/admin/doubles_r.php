...
<h2>Player Data</h2>
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM doubles";
                            $result = mysqli_query($conn, $sql);

                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>";
                                echo "<td>{$row['mid']}</td>";
                                echo "<td>{$row['teamid1']}</td>";
                                echo "<td>{$row['teamid2']}</td>";
                                ...
                                echo "<td><a href='update_doubles.php?mid={$row['mid']}' class='btn btn-primary m-2'>Update</a></td>";
                                echo "</tr>";
                            }
